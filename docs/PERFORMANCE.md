...
| 文件 | 变化 | 说明 |
| --- | --- | --- |
| `source/images/avatar.png` | 9.9 KB → **15.8 KB** | 换成新 logo，仍是 96×96；体积翻倍但绝对值依旧很小 |
...
- 头像从原图**裁到头部**再缩放：页头只显示 48×48，整幅插画缩下去只剩一个模糊人影，裁到头部才认得出是张脸；分享图反过来用完整原图，缩放后左右补白到 1200×630，不裁切。
